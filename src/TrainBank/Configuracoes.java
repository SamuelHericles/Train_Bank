...
/*
 * Nesta classe temos toda os utilit·rios para formataÁ„o da tela do usu·rio
 * */
...
public class Configuracoes  extends JFrame implements ActionListener{
    ...
    public Configuracoes(){
      ...
      //Todos os butıes e suas respectivas funcionalidades
    ...
    }//Fim da classe de configuraÁıes
    
    //Tratador de erros de entrada do usu·rio
    @Override
